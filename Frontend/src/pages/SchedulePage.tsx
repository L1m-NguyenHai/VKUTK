    ...
    <div className="h-full overflow-y-auto p-4 md:p-6">
      <div className="space-y-4 max-w-5xl mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div
            className={`flex items-center space-x-1.5 md:space-x-2 text-xs md:text-sm ${
        ...
        <div
          ...
          } border rounded-xl md:rounded-lg p-3 md:p-3 shadow-md md:shadow-sm`}
        >
          <div className="flex items-center space-x-2 mb-3 md:mb-2">
            <div
              className={`p-2 md:p-1.5 rounded-lg ${
                themeMode === "dark" ? "bg-purple-900/50" : "bg-purple-100"
              }`}
            >
              <Clock
            ...
            <span
              className={`text-base md:text-sm font-semibold ${
                themeMode === "dark" ? "text-purple-300" : "text-purple-900"
              }`}
            >
              Hôm nay - {today}
            </span>
          ...
          <div className="space-y-2">
            {todayClasses.map((item) => (
              <div
                ...
                } rounded-xl md:rounded-lg p-3.5 md:p-3 border shadow-md md:shadow-sm active:scale-95 md:hover:shadow-md transition-all`}
              >
                ...
                <div
                  className={`flex items-center justify-between text-sm md:text-xs ${
                    themeMode === "dark" ? "text-gray-400" : "text-gray-600"
                  }`}
                >
                  <span>{item.time}</span>
                ...
                <p
                  className={`text-xs mt-1.5 md:mt-1 ${
          ...
          <div className="space-y-2">
            {schedule.map((item) => (
              <div
                ...
                className={`${
                  themeMode === "dark"
                    ? "bg-gray-800 border-gray-700 md:hover:border-gray-600"
                    : "bg-white border-gray-200 md:hover:border-gray-300"
                } border rounded-xl md:rounded-lg p-3.5 md:p-3 active:scale-95 transition-all`}
              >
                <div className="flex justify-between items-start mb-2 md:mb-1">
                  <div>
                    <h3
                  ...
                  <span
                    ...
                    } px-2.5 md:px-2 py-1 rounded-lg md:rounded`}
                  >
                    {item.day}
                  </span>
                </div>
